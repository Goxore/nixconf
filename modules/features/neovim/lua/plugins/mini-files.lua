    ...
    after = function()
        ...
        vim.api.nvim_create_autocmd("User", {
            ...
            callback = function(args)
                ...
                map_mini_files(buf, "gm", function()
                    local target = require("mini.files").get_explorer_state().target_window
                    local name = vim.api.nvim_buf_get_name(vim.api.nvim_win_get_buf(target))
                    return name ~= "" and name or nil
                end, "Go to parent directory")
